...
if (-not $OutputDirectory) {
    $OutputDirectory = Join-Path $PSScriptRoot '../client/PetVerseClient/assets/resources/ui/adventure-v3'
}
New-Item -ItemType Directory -Path $OutputDirectory -Force | Out-Null

$outputPath = Join-Path $OutputDirectory 'adventure-map-page-v3.png'
...
if (-not (Test-Path $imageMetaPath)) {
    ...
    $meta = [ordered]@{
        ...
        subMetas = [ordered]@{
            '6c48a' = [ordered]@{
                importer = 'texture'; uuid = $textureUuid; displayName = 'adventure-map-page-v3'; id = '6c48a'; name = 'texture'
            ...
            'f9941' = [ordered]@{
                importer = 'sprite-frame'; uuid = $frameUuid; displayName = 'adventure-map-page-v3'; id = 'f9941'; name = 'spriteFrame'
                userData = [ordered]@{
